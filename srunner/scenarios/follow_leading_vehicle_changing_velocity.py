...
class FollowLeadingVehicleChangingVelocity(BasicScenario):
  ...
  def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
    ...
    self._first_vehicle_x_offset = 30
  ...
  def _create_behavior(self):
    ...
    _drive_for_distance(self, drive, 16, 100)
    _drive_for_distance(self, drive, 15, 10)
    _drive_for_distance(self, drive, 14, 10)
    _drive_for_distance(self, drive, 13, 10)

    _drive_for_distance(self, drive, 12, 50)
    _drive_for_distance(self, drive, 11, 10)
    _drive_for_distance(self, drive, 10, 10)
    _drive_for_distance(self, drive, 9, 10)
    
    _drive_for_distance(self, drive, 8, 50)
    ...
    _drive_for_distance(self, drive, 9, 5)
    _drive_for_distance(self, drive, 8, 5)
    _drive_for_distance(self, drive, 7, 4)
    _drive_for_distance(self, drive, 6, 4)
    _drive_for_distance(self, drive, 5, 3)
    _drive_for_distance(self, drive, 4, 2)
    _drive_for_distance(self, drive, 3, 1)
    _drive_for_distance(self, drive, 2, 1)
